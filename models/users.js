...
async function getPagedUsers(
  ...
  if (search !== "" && search !== undefined) {
    ...
    queryVal = `true AND username ILIKE ${search} OR first_name ILIKE ${search} OR last_name ILIKE ${search} OR email ILIKE ${search} OR OR created_at ILIKE ${search} OR region ILIKE ${search} OR assignee ILIKE ${search} OR status ILIKE ${search}`;
  }
